...
// --- Meeting Summary ---
function MeetingSummary({ summary, loading }) {
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: 28 }}>
            <div style={{ maxWidth: 800, margin: "0 auto", display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              {tab === "summary" && <><MeetingSummary summary={active?.summary} loading={summaryLoading} />{active?.summary && !summaryLoading && <button onClick={() => setTab("email")} style={{ padding: "12px 24px", borderRadius: 12, alignSelf: "center", background: t.blueDim, border: `1px solid ${t.blue}33`, color: t.blue, fontSize: 13, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}><I d={ic.send} size={14} color={t.blue} />Draft Follow-Up Email</button>}</>}
